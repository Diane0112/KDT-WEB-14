exports.getVisitors = () => {
  return [
    ...
    { id: 1, name: "이찬력", comment: "으라차차." },
  ];
};

//mysql 연결

//mysql2/promise : paramise 객체로 사용가능한 방식
const mysql = require("mysql2/promise");

// DB연결
// createConnection: 단일연결
// - 요청할 때마다 새로운 연결을 생성
//- 적은 수의 동시 연결이나 단순한 데이터 베이스 쿼리일 때 사용
// createPool:다중연결ㄴ
//-연결 풀을 생성 풀은 미리 정의된 수의 연결을 생성하고 관리
//-요청이 들어오면 연결 풀에서 사용가능한 연결을 제공. 작업 완료 후
//-연결이 필요하지 않을 경우 자동 반환, 풀의 연결 수를 제한하고
//-일반적인 웹 서비스에 적합
